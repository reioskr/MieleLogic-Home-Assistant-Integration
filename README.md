...
The integration reverse-engineers the MieleLogic web app API:
- **Auth**: OAuth2 password grant to `sec.mielelogic.com`
- **Data**: REST API at `api.mielelogic.com/v7`
- **Polling**: every 2 minutes for machine states and timetable

No browser emulation or Chromium needed - it talks directly to the API.
